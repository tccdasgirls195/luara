...
// Maria A. Permitir: professor, adm, coordenador e gestão entrar no agendamento:
if ($_SESSION['usuario_tipo'] !== 'professor' && $_SESSION['usuario_tipo'] !== 'administrador' && $_SESSION['usuario_tipo'] !== 'coordenador' && $_SESSION['usuario_tipo'] !== 'gestao') {
